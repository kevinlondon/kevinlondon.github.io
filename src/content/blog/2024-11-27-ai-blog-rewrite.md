...
I started with Aider, powered by Claude - one of the more capable AI options available. My first request? "Convert this Jekyll blog to Astro." The result:
...
The experience felt frustrating. Aider kept asking me to start the dev server (`npm run dev`), which blocked any other input. I couldn't guide it or course-correct beyond yes / no - I just watched it make decisions.
...
Then I tried Cursor and everything clicked. The autocomplete kicked in right away, I could see exactly what it planned to do, and the whole thing felt responsive. After dealing with Copilot's lag in IntelliJ, this felt like a real upgrade.

I used Cursor with Claude 3.5 Sonnet to tackle the URL structure first:
